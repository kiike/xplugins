...

{
    ...
    /****************** Make Message One Digit at A Time ************************/
      unsigned char radioadigit1 = radioadig1, radioadigit2 = radioadig2;
      unsigned char radioadigit3 = radioadig3, radioadigit4 = radioadig4;
      unsigned char radioadigit5 = radioadig5, radiobdigit1 = radiobdig1;
      unsigned char radiobdigit2 = radiobdig2, radiobdigit3 = radiobdig3;
      unsigned char radiobdigit4 = radiobdig4, radiobdigit5 = radiobdig5;
      unsigned char radiocdigit1 = radiocdig1, radiocdigit2 = radiocdig2;
      unsigned char radiocdigit3 = radiocdig3, radiocdigit4 = radiocdig4;
      unsigned char radiocdigit5 = radiocdig5, radioddigit1 = radioddig1;
      unsigned char radioddigit2 = radioddig2, radioddigit3 = radioddig3;
      unsigned char radioddigit4 = radioddig4, radioddigit5 = radioddig5;

      /******************* Load Array with Message of Digits *********************/
        radiowbuf[radnum][0] = radioadigit1, radiowbuf[radnum][1] = radioadigit2;
        radiowbuf[radnum][2] = radioadigit3, radiowbuf[radnum][3] = radioadigit4;
        radiowbuf[radnum][4] = radioadigit5, radiowbuf[radnum][5] = radiobdigit1;
        radiowbuf[radnum][6] = radiobdigit2, radiowbuf[radnum][7] = radiobdigit3;
        radiowbuf[radnum][8] = radiobdigit4, radiowbuf[radnum][9] = radiobdigit5;
        radiowbuf[radnum][10] = radiocdigit1, radiowbuf[radnum][11] = radiocdigit2;
        radiowbuf[radnum][12] = radiocdigit3, radiowbuf[radnum][13] = radiocdigit4;
        radiowbuf[radnum][14] = radiocdigit5, radiowbuf[radnum][15] = radioddigit1;
